...
function (e) {
	...
	r.prototype._getBase64 = function () {
	    ...
	    return new o(function (i) {
			...
			function () {
				...
				s.oldIOS ? e._createBase64ForOldIOS().then(i) : e._createBase64().then(i)
			})
	    })
	},
	...
	r.prototype._createBase64 = function () {
	    ...
	    return new o(function (e) {
	        s.oldAndroid || s.mQQBrowser || !navigator.userAgent ? n.e(2,
			function (t) {
	...
	r.prototype._getResize = function () {
	    ...
	    if (o && "5678".indexOf(o) > -1 && (a.width = t.height, a.height = t.width, r = n.height, i = n.width), a.width < r || a.height < i) return a;
...
function (e, t, n) {
    var r, i; (function () {
        ...
        function l(e, t, n) {
			...
			l = t; t + n > l;) 28 === u.getUint8(l) && 2 === u.getUint8(l + 1) && (a = u.getUint8(l + 2), a in P && (o = u.getInt16(l + 3), s = o + 5, i = P[a], r = f(u, l + 5, o), c.hasOwnProperty(i) ? c[i] instanceof Array ? c[i].push(r) : c[i] = [c[i], r] : c[i] = r)),
			l++;
            return c
        }
        ...
        function h(e, t, n, r, i) {
            ...
            switch (d) {
                ...
                case 4:
                    ...
                    return a;
                case 5:
                    if (1 == h) return c = e.getUint32(g, !i),
                    l = e.getUint32(g + 4, !i),
                    s = new Number(c / l),
                    s.numerator = c,
                    s.denominator = l,
                    s;
                    for (a = [], u = 0; h > u; u++) c = e.getUint32(g + 8 * u, !i),
        ...
        function g(e, t) {
            if ("Exif" != f(e, t, 4)) return p && console.log("Not valid EXIF data! " + f(e, t, 4)),
			!1;
            var n, r, i, o, a, s = t + 6;
